...
class TaskExecution(Thread):
    ...
    def get_task_state(self):
        return self.backend.get_task_state(self.task_id)

    def set_task_state(self, state: str):
        self.backend.set_task_state(self.task_id, state)
    ...
    def prepare(self):
        ...
        self.backend.save_task_info(self.task_id, task_info)
        prep_error = None
    ...
    def set_state(self, target_state: str) -> TaskState:
        state = self.backend.get_task_state(self.task_id)
